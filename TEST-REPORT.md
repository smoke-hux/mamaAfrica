...
|-------|---------|-------|-------|--------|
| Unit (cart store, pricing, formatting, checkout validation) | `npm run test:unit` | 4 | 50 | ✅ all pass |
| API (products, categories, promo, quotes, orders, newsletter, persistence) | `npm run test:api` | 3 | 69 | ✅ all pass |
| End-to-end, desktop Chrome + mobile Chrome (Pixel 7) | `npm run test:e2e` | 3 | 38 | ✅ all pass |
| **Total** | `npm test` | 10 | **157** | ✅ |
